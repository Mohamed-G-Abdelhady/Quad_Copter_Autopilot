...
//adaption
double uP_k0 , uP_k1 = 1 ;
double eP_k0  = 0, eP_k1 = 0.0 , r1_P , s0_P , s1_P ;
double B_P = 0;

double uR_k0 , uR_k1 = 1 ;
double eR_k0  = 0, eR_k1 = 0.0 , r1_R , s0_R , s1_R ;
double B_R = 0;

double uY_k0 , uY_k1 = 1 ;
double eY_k0  = 0, eY_k1 = 0.0 , r1_Y , s0_Y , s1_Y ;
double B_Y = 0;
...
//else Serial.print("hovering");
    ...
    { 
 if (Duty > heating) {Duty=Duty - 0.2;  Serial.print("landing"); }  //.1 is equal to (hovering - heating)*.01/required time to take off)       
...
Serial.print('\t');          Serial.print(PITCH * 180 / M_PI);
Serial.print('\t');          Serial.print(uP_k0);
Serial.print('\n'); 
